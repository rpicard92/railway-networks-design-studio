"""
This script is called by the plugin-wrapper, MiniProject2Plugin.js, which passes down the
...
from MiniProject2Plugin import MiniProject2Plugin
...
plugin = MiniProject2Plugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
